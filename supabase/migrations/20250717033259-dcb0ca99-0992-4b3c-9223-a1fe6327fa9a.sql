-- Complete Multi-Tenant ERP Database Schema
...
-- Populate DKEGL item_master from existing artworks data
INSERT INTO public.item_master (
  item_code, item_name, category_id, customer_name, dimensions, 
  no_of_colours, file_hyperlink, file_id, coil_size, total_runs,
  last_run, length, circum, ups, cyl_qty, cut_length, remarks,
  qr_code, location, mielage_m
)
SELECT 
  a.item_code,
...
-- Populate substrates from existing substrate_master_dkpkl
...
-- Create sample GRN entries based on order patterns
