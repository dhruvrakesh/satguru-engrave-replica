...
-- Create sample categories for Satguru (using correct columns)
...
INSERT INTO public.satguru_item_master (item_code, item_name, category_id, uom, customer_name, dimensions, status) 
SELECT 
