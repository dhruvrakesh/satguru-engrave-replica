-- Add missing columns to satguru_stock table and insert test data

-- Add the missing columns that should be in the stock table
...
-- Now insert test data into Satguru tables for testing
...
INSERT INTO public.satguru_stock (item_code, current_qty, min_stock_level, max_stock_level, reorder_level)
VALUES 
('SAT001', 100, 10, 500, 15),
('SAT002', 50, 5, 200, 10)
