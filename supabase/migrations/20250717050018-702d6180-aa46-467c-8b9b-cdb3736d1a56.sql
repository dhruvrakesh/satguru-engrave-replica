...
('Finished Goods', 'Finished products ready for sale', true),
('Packaging Materials', 'Materials used for packaging', true),
('Chemicals', 'Chemical components and additives', true)
ON CONFLICT (category_name) DO NOTHING;

-- Create sample item master for Satguru
INSERT INTO public.satguru_item_master (item_code, item_name, category_id, uom, customer_name, dimensions, is_active, status) 
SELECT 
  'SAT_' || generate_random_uuid()::text,
  item_names.name,
  sc.id,
  'KG',
  'Sample Customer',
